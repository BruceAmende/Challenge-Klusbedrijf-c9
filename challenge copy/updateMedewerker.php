...
<h2>Update medewerker</h2>

<form action="db.conn/db.connUpdate.php" method="get">
        <input type="hidden" name="id" value="<?php echo $_GET['id'];?>">
        <input  type="text"placeholder='Naam' name="naam" value="<?php echo $database_gegevensM['naam']?>"><br>
        <br>
        <input type="text"placeholder='Email' name="email"value="<?php echo $database_gegevensM['email']?>"><br>
        <br>
