...
$sql = "UPDATE gebruikers SET naam= :naam,email=:email,wachtwoord=:ww,geboortedatum=:geboortedatum,adres=:adres,postcode=:postcode,stad=:stad,telefoonnummer=:tel where id=:id";
